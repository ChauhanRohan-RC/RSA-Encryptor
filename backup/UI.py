...
from __c import resources_check, ImPaths
...
b_bd = 0
b_bg = 'black'
b_fg = rgb(210, 210, 210)
b_abg = rgb(40, 40, 40)
b_afg = 'skyblue'
b_hoverbg = rgb(20, 20, 20)
b_hoverfg = 'skyblue'

# Menu Buttons
menu_b_font = 'Comicsans 14'
menu_b_relief = 'flat'
menu_b_bd = 0

# Title Labels
tl_font = 'comicsans 13'
tl_relief = 'flat'
tl_bd = 0
...
e_bg = 'white'
e_fg = 'black'
e_font_small = 'comicsans 10'
e_font_large = 'comicsans 13'
e_relief = 'groove'
e_bd = 2

# Listbox
list_font = 'comicsans 10'
list_bd = 0
list_relief = 'flat'
list_bg = rgb(0, 0, 0)
list_fg = rgb(210, 210, 210)
list_abg = rgb(60, 60, 60)
list_afg = 'white'
...
class EncFileIn(Frame):
    ...
    def __init__(self, master, main_tk, enc_ext=C.EncExt, next_call=lambda _a='Next': print(_a),
        ...
        self.title_l = Label(self, bg=bg, fg=fg, relief=tl_relief, font=tl_font, bd=tl_bd,
                             text='Encryption : Select Files', anchor='center')
...
class EncUserIn(Frame):
    ...
    def __init__(self, master, main_tk, enc_ext=C.EncExt, next_call=lambda _a='Next': print(_a),
        ...
        self.conf_l = Label(self.pass_frame, bg=bg, fg=fg, font=l_font, text=' Confirm ', relief=l_relief, bd=l_bd,
                            anchor='center', width=10)
        self.pass_e = Entry(self.pass_frame, bg=e_bg, fg=e_fg, font=e_font_small, relief=e_relief, bd=e_bd, show='*',
                            textvariable=self.user_pass)
        self.conf_e = Entry(self.pass_frame, bg=e_bg, fg=e_fg, font=e_font_small, relief=e_relief, bd=e_bd, show='*')
        ...
        self.path_e = Entry(self.path_frame, bg=e_bg, fg=e_fg, font=e_font_small, relief=e_relief, bd=e_bd,
...
class EncUi(Frame):
    ...
    def next_file_in(self, event=None):  # Next at file input
        ...
        _name = format_path(os.path.splitext(os.path.basename(self.file_in_frame.files[0]))[0] + '--' + os.path.splitext(os.path.basename(self.file_in_frame.files[-1]))[0] + C.EncExt, 50)
...
class DecPassCheck(Frame):
    def __init__(self, master, main_tk, chances=C.DecChances, caption='Enter Password',
        ...
        self.pass_e = Entry(self, bg=e_bg, fg=e_fg, font=e_font_small, relief=e_relief, bd=e_bd, show='*')
...
class MainMenu(Frame):
    def __init__(self, master, enc_command, dec_command, **kwargs):
        ...
        # Buttons
        self.enc_b = HoverB(self, text=' Encryption   ', image=self.master.enc_im, compound='right', command=self.enc_command,
                            bg=b_bg, fg=b_fg, abg=b_abg, afg=b_afg, hoverbg=b_hoverbg, hoverfg=b_hoverfg,
                            font=menu_b_font,
